...
public class WeightRounderTest {
    ...
    public void roundsCorrectly() {
        double result = WeightRounder.roundUpToNearest2_5(100);
        assertEquals(100, result, 0.0001);

        result = WeightRounder.roundUpToNearest2_5(101);
        assertEquals(102.5, result, 0.0001);

        result = WeightRounder.roundUpToNearest2_5(102.5);
        assertEquals(102.5, result, 0.0001);

        result = WeightRounder.roundUpToNearest2_5(103.5);
